...
export class Diagnostics {
  ...
  private async collect(){
    ...
    const report=clean({
      ...
      runtime:state.runtime?pick(state.runtime,['maxTurns','maxMinutes','maxTokens','modelRetries','requestTimeoutMs','maxOutputTokens','parallelReads','fileCheckpoints','wakeAllGroupBots']):undefined,
