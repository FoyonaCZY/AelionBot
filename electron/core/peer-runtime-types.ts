...
export interface HarnessRunOptions {designSessionId?:string;resumeRunId?:string;workItemId?:string;workspaceDir?:string|null;attachments?:import('../../src/attachment-types').Attachment[];inputMessageIds?:string[];supersedesRunId?:string;reactionMessageId?:string;mentions?:BotMention[];peerOrigin?:PeerRunOrigin;groupOrigin?:GroupRunOrigin;groupContext?:string;groupTaskFrom?:string;privateSessionId?:string;peerContext?:string;onStarted?:(runId:string)=>void;}
export interface PeerGateway {
  waitResult?:(botId:string,runId:string,exchangeId:string,signal:AbortSignal)=>Promise<{content:string;attachments?:import('../../src/attachment-types').Attachment[];receipt?:unknown}>;
