...
export function runtimeSettings(value:unknown):RuntimeSettings{
 ...
 const ranges={maxTurns:[0,10000],maxMinutes:[1,1440],maxTokens:[10000,10000000],modelRetries:[0,5],requestTimeoutMs:[1000,600000],maxOutputTokens:[256,65536],parallelReads:[1,8],progressSeconds:[15,600]} as const;
