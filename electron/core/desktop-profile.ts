...
export const WORKSTATION_VERSION = '2';
...
const files:Record<string,string>={
  ...
  '/home/aelion/.config/xfce4/helpers.rc':'WebBrowser=google-chrome\nFileManager=Thunar\nTerminalEmulator=xfce4-terminal\n',
  ...
  '/home/aelion/Desktop/Chrome.desktop':launcher('Chrome','/usr/local/bin/aelion-session google-chrome-stable --no-first-run --no-default-browser-check file:///usr/local/share/aelion/start.html','google-chrome'),
...
kernel=$(find /boot -maxdepth 1 -name 'vmlinuz-*-amd64' ! -name '*cloud*' | sort -V | tail -n 1 | sed 's|.*/vmlinuz-||')
test -n "$kernel"
...
command -v google-chrome-stable thunar libreoffice xclip xdotool
