export const READ_TOOLS=new Set(['view_image','tool_search','web_read','web_search','mcp_list_resource_templates','file_read','host_file_read','host_list_directory','host_find_files','host_search_files','skill_read','skill_file_read','skills_list','history_read','history_search','read_result','attachment_read','execution_list','task_read','goal_read','process_list','process_status','mcp_list_servers','mcp_list_tools','mcp_list_resources','mcp_read_resource','mcp_list_prompts','mcp_get_prompt']);
