...
</style></head><body><div id="status" role="status"></div><form><textarea rows="1" maxlength="12000"></textarea><button type="submit"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19V5m-6 6 6-6 6 6"/></svg></button></form><script nonce="feedback">
