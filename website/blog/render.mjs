...
export function icon(name,size=18){
  const shapes={arrow:'<path d="M4 12h15m-6-6 6 6-6 6"/>',menu:'<path d="M4 7h16M4 12h16M4 17h16"/>',file:'<path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9zM14 3v6h6M8 13h8M8 17h5"/>',clock:'<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>'};
