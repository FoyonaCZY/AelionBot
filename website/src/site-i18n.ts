...
export const siteQuestions:Record<SiteLanguage,ReadonlyArray<{question:string;answer:string}>>={
  ...
  'zh-TW':[
    {question:'怎樣開始和夥伴一起工作？',answer:'下載 Windows 版，依照引導連線你想使用的 AI 服務。替夥伴取名、安排職責，就能交給它第一件事。AI 服務費用依你選擇的服務計算。'},
    ...
    {question:'有 Mac 版本嗎？',answer:'有 Mac 預覽版，可在下載頁面的歷史版本中找到。目前優先提供 Windows 版；Mac 使用說明見下載區域的預覽版說明。'},
  ],
  en:[
    {question:'How do I start working with a partner?',answer:'Download the Windows build and connect the AI service you want to use. Name your partner, give it a role, and hand it a first task. AI service charges depend on the service you choose.'},
    ...
    {question:'Is there a Mac version?',answer:'A Mac preview build is available in the download page’s release history. Windows is the primary build for now; Mac notes are linked in the download section.'},
  ]
};
