...
const browser=new WebPreviewBrowser(window,vm as any,{read:async(_bot:string,path:string)=>Buffer.from(path.endsWith('.js')?'document.title="Relative script loaded"':'<script src="assets/app.js"></script><h1>你好</h1>')} as any,{} as any);
