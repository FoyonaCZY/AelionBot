...
export function computerNeedsAppUpdate(vm:VmState){return vm.appsReady===false&&(vm.status==='stopped'||vm.status==='ready')&&!vm.maintenance&&!vm.needsReboot&&!vm.lastError;}
