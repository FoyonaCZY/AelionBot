...
export interface ProviderModel {id:string;contextTokens?:number;reasoningEffort?:string;thinkingBudget?:number;supportsImages?:boolean;hostedWebSearch?:boolean;hostedImageGeneration?:boolean;}
...
export interface ModelConfig extends ModelParameters { supportsImages?:boolean;hostedWebSearch?:boolean;hostedImageGeneration?:boolean;baseUrl: string; model: string; hasKey: boolean; contextTokens: number; providerId?:string;providerName?:string;issue?:string; }
