...
import {botAvatarContent} from './bot-avatar';
...
export function Avatar({bot,size=44,activity='idle'}:{bot:Pick<Bot,'name'|'color'|'avatarStyle'>&{id?:string};size?:number;activity?:BotActivity}){
