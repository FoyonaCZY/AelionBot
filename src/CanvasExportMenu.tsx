...
export function CanvasExportMenu({name,rich,disabled,exporting=false,onExport}:{name:string;rich:boolean;disabled:boolean;exporting?:boolean;onExport:(format:CanvasExportFormat|'original')=>void}){
