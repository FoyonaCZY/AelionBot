...
export interface GroupPage {tasks?:GroupTask[];pins?:Record<string,MessagePin[]>;group:GroupSummary;messages:GroupMessage[];deliveries:GroupDelivery[];before?:string;}
